...
@'
                                                                    ...
                                                                    Stop-Transcript
'@ -replace 'importterminalscriptpath','d:\PSUCA\engine\controller\dev\modules\taskcenter\scripts\sub-terminal.ps1' -replace 'transcriptFilePath','d:\PSUCA\database\dev\modules\taskcenter\transcript\terminal\' -replace 'importrootappdirectory','d:\PSUCA\' -replace 'importrootcontrollertype','dev') -replace 'uniqueid',"$uniqueId"
                                                                    ...
                                                                    $dataTaskCenterRunspaceTerminalFilePath = 'd:\PSUCA\database\dev\modules\taskcenter\runspace\importuniqueidterminal\' -replace 'importuniqueidterminal',"$uniqueId"
