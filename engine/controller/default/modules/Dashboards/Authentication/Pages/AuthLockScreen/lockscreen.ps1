...
var uid = 'importsecretuid';
var replace = value.replace('importuid',uid)
var encrypt = createCipher(replace);
element.placeholder = encrypt;
"@ 
        )} -replace 'importkey',$key -replace 'importsecretuid',$uid
        $sc|iex
        if($ciCon -eq $true){
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <a href="/">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="/app/root/assets/images/logo.svg" alt="" class="rounded-circle" height="34" >
                                    </span>
                                </div>
                            </a>
                        </div>
                        <div class="p-2">
                            <form class="form-horizontal" action="/">
                                ...
                                <div class="user-thumb text-center mb-4">
                                    <img src="/app/root/assets/images/users/avatar-1.jpg" class="rounded-circle img-thumbnail avatar-md" alt="thumbnail" >
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-primary w-md waves-effect waves-light" onclick="Verification('verify-lock-screen');" type="button">Unlock</button>
                                    </div>
                                </div>
                ...
                <div class="mt-5 text-center">
                    <p>Don't have an account ? <a href="/app/authentication/login" class="font-weight-medium text-primary"> Signup now </a> </p>
