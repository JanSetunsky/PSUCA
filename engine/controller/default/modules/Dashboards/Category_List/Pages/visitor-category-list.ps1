    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item noti-icon waves-effect ecommerce-navbar-btn-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i id="ecommerce-navigation-lock-i" class="bx bx-lock ecommerce-mt-0-5"></i>
            </button>
...
<div class="col px-0">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 float-left">
        ...
        <div class="card ecommerce-category-list-news-layout">
            <div class="card-body p-2">    
                <div class="row mb-0">
                    <div class="col">
                ...
                <!-- CATEGORY LIST NEWS SLIDESHOW -->
    
                    <div>
                        <div class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner ecommerce-news-item-inner-content">
                             
                            
                                <div id="news-seller-slide-1" class="slide-1 slide-style carousel-item active">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                                    <div class="product-img position-relative ecommerce-category-list-news-product-img">
                                ...
                                <div id="news-seller-slide-2" class="slide-2 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-3" class="slide-3 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-4" class="slide-4 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-5" class="slide-5 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-6" class="slide-6 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-7" class="slide-7 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-8" class="slide-8 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-9" class="slide-9 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-10" class="slide-10 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-11" class="slide-11 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-12" class="slide-12 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-13" class="slide-13 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                                ...
                                <div id="news-seller-slide-14" class="slide-14 slide-style carousel-item">
                                    <div class="ecommerce-product-list-item-size justify-content-center">
                                        <div class="p-0">
                                            <div class="container px-0">
                                                <div class="container p-1 pb-1">
                    ...
                    <a class="carousel-product-slideshow-control-prev" onclick="slideshowBtnLeftSide('ecommerce-news-item-inner-content')" role="button">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-product-slideshow-control-next" onclick="slideshowBtnRightSide('ecommerce-news-item-inner-content')" role="button">
    ...
    <div class="card">
        <div class="card-body pl-2 pr-2 pt-1 pb-1">
            <div class="row pl-2 pr-2 pt-0">
                <div class="col-4 p-1">
                    <a class="col btn btn-light ecommerce-category-list-sort-btn px-0" data-toggle="collapse" href="#multiCollapseSubCategory" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
                        <i class="bx bx-collection font-size-20 noti-icon pb-1"></i>
                        <span class="pb-1 ecommerce-category-list-sort-span">Subcategory</span>
                    </a>
                </div>

                <div class="col-4 p-1">
                    <a class="col btn btn-light ecommerce-category-list-sort-btn px-0" data-toggle="collapse" href="#multiCollapseSorting" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
                        <i class="bx bxs-sort-alt font-size-20 noti-icon pb-1"></i>
                        <span class="ecommerce-category-list-sort-span">Sorting</span>
                    </a>
                </div>  

                <div class="col-4 p-1">
                    <a class="col btn btn-light ecommerce-category-list-sort-btn px-0" data-toggle="collapse" href="#multiCollapseParameters" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
                        <i class="bx bx-customize font-size-20 noti-icon pb-1"></i>
                        <span class="ecommerce-category-list-sort-span">Parameters</span>
                    </a>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    <div class="collapse multi-collapse mb-2 show" id="multiCollapseSubCategory">
                        <div class="card card-body mb-0 pl-1 pr-2 pb-0 pt-0">
                            <div class="row p-1">
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 p-1">
                                    <a class="ecommerce-subcategory-item-link" href="#">
                                        <div class="ecommerce-subcategory-item-box border">
                                            <div class="ecommerce-subcategory-item-img ml-1">
                                                <img src="/app/root/assets/images/svg/image.svg" class="bx-image ecommerce-subcategory-item-img img-fluid mx-auto d-block float-left" alt="...">
                                            </div>
                                            <div class="ecommerce-subcategory-item-text mt-1">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 p-1">
                                    <a class="ecommerce-subcategory-item-link" href="#">
                                        <div class="ecommerce-subcategory-item-box border">
                                            <div class="ecommerce-subcategory-item-img ml-1">
                                                <img src="/app/root/assets/images/svg/image.svg" class="ecommerce-subcategory-item-img img-fluid mx-auto d-block float-left" alt="...">
                                            </div>
                                            <div class="ecommerce-subcategory-item-text mt-1">
                                                <p class="pl-3 mb-0 text-left">T-Shirt Specific Category</p>
                                            </div>                                            
                    ...
                    <div class="collapse multi-collapse mb-2" id="multiCollapseParameters">
                        <div class="card card-body mb-0 pl-2 pr-2 pb-0 pt-0">
                            <div class="row p-1">
                                <div class="col p-0">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-1">
                                                <h5 class="font-size-14 mb-3 mt-0">Parameter type</h5>
                                            </div>
                                        </div>              
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pl-2">
                                                        <a class="btn btn-light btn-sm" href="#" role="button">
                                                            <i class="bx bx-plus font-size-20 mt-1"></i>
                                                        </a> 
                                                    </td>                                            
                                                </tr>
                                            </table>
                                        ...
                                        <div class="col-12 px-3 py-2">
                                            <div class="ecommerce-categpry-parameter-item border border-secondary text-secondary bg-light text-secondary">
                                                <span>Parameter name</span>
                                                <i class="mdi mdi-close noti-icon pl-1"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="best-seller-slide-1" class="slide-1 slide-style carousel-item active">
                                <div class="ecommerce-product-list-item-size justify-content-center">
                                    <div class="p-0">
                                        <div class="container px-0">
                                            <div class="container p-1 pb-1">
                                                <div class="product-img position-relative ecommerce-category-list-best-seller-product-img">
                                                    <div class="avatar-sm product-ribbon">
                                                        <span class="avatar-title rounded-circle  bg-primary">
                                                            - 25 %
                                                        </span>
                            ...
                            <div id="favourites-slide-1" class="slide-1 slide-style carousel-item active">
                                <div class="ecommerce-product-list-item-size justify-content-center">
                                    <div class="p-0">
                                        <div class="container px-0">
                                            <div class="container p-1 pb-1">
                                                <div class="product-img position-relative ecommerce-category-list-favourites-product-img">
                                                    <div class="avatar-sm product-ribbon">
                                                        <span class="avatar-title rounded-circle  bg-primary">
                                                            - 25 %
                                                        </span>
                            ...
                            <div id="discount-slide-1" class="slide-1 slide-style carousel-item active">
                                <div class="ecommerce-product-list-item-size justify-content-center">
                                    <div class="p-0">
                                        <div class="container px-0">
                                            <div class="container p-1 pb-1">
                                                <div class="product-img position-relative ecommerce-category-list-discount-product-img">
                                                    <div class="avatar-sm product-ribbon">
                                                        <span class="avatar-title rounded-circle  bg-primary">
                                                            - 25 %
                                                        </span>
