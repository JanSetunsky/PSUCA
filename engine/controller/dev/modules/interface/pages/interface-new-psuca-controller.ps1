                ...
                New-UDColumn -SmallSize 12 -MediumSize 12 -LargeSize 12 {
                    New-UDElement -Tag 'table' -Content {
                        New-UDElement -Tag 'tr' -Content {
                            ...
                            New-UDElement -Tag 'td' -Content {
                                New-UDElement -Tag 'tr' -Content {
                                    New-UDTypography -Text 'Create New Psuca Controller Form' -ClassName 'interface-box-title'
                                }
                            }
                        }
                    }
                    New-UDStyle -Content {
                        ...
                        } -SubmitText 'Create New Psuca Controller' -OnSubmit {
...
"@)                                    
                            ...
                            if($MainValidationConditionResult -eq $true){
                                ...
                                $NewItem = New-item -ItemType File ("$Cache:InterfacePsucaControllerBlockDatabasePath"+"$CreateNewFileJsonString") -Force
                                $SaveContent = Set-Content ("$Cache:InterfacePsucaControllerBlockDatabasePath"+"$CreateNewFileJsonString") -Value $ExportJson -Force
