                ...
                New-UDColumn -SmallSize 12 -MediumSize 12 -LargeSize 12 {
                    New-UDElement -Tag 'table' -Content {
                        New-UDElement -Tag 'tr' -Content {
                            ...
                            New-UDElement -Tag 'td' -Content {
                                New-UDElement -Tag 'tr' -Content {
                                    New-UDTypography -Text 'Create New Server Form' -ClassName 'interface-box-title'
                                }
                            }
                        }
                    }
                    New-UDStyle -Content {
                        ...
                        } -SubmitText 'Create New Server' -OnSubmit {
...
"@)                                    
                            ...
                            if($MainValidationConditionResult -eq $true){
                                ...
                                $NewItem = New-item -ItemType File ("$Cache:InterfaceServerBlockDatabasePath"+"$CreateNewFileJsonString") -Force
                                $SaveContent = Set-Content ("$Cache:InterfaceServerBlockDatabasePath"+"$CreateNewFileJsonString") -Value $ExportJson -Force
